...
void GameRenderer::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo) {
    createInfo = {};
...
VKAPI_ATTR VkBool32 VKAPI_CALL GameRenderer::debugCallback(
...
VkResult GameRenderer::CreateDebugUtilsMessengerEXT(VkInstance instance,
...
void GameRenderer::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger,
                                          const VkAllocationCallbacks *pAllocator) {
